...
namespace PascalABCCompiler.SyntaxTree
{
	...
	public class function_lambda_definition : expression
	{
		...
		///Конструктор с параметрами.
		///</summary>
		public function_lambda_definition(ident_list _ident_list,type_definition _return_type,formal_parameters _formal_parameters,statement _proc_body,procedure_definition _proc_definition,expression_list _parameters,string _lambda_name,List<declaration> _defs,bool _visit_for_type_inference)
		{
			...
			this._defs=_defs;
			this._visit_for_type_inference=_visit_for_type_inference;
		}

		///<summary>
		///Конструктор с параметрами.
		///</summary>
		public function_lambda_definition(ident_list _ident_list,type_definition _return_type,formal_parameters _formal_parameters,statement _proc_body,procedure_definition _proc_definition,expression_list _parameters,string _lambda_name,List<declaration> _defs,bool _visit_for_type_inference,SourceContext sc)
		{
			this._ident_list=_ident_list;
			this._return_type=_return_type;
			this._formal_parameters=_formal_parameters;
		...
		protected bool _visit_for_type_inference;
		...
		///
		///</summary>
		public bool visit_for_type_inference
		{
			get
			{
				return _visit_for_type_inference;
			}
			set
			{
				_visit_for_type_inference=value;
			}
		}
