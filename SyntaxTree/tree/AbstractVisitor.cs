...
namespace PascalABCCompiler.SyntaxTree
{
	...
	public class AbstractVisitor: IVisitor
	{
        ...
        {
            DefaultVisit(_declaration); // было пропущено
        }
        ...
        {
            DefaultVisit(_function_lambda_definition); // в оригинале обход списка закомментирован
        }
        ...
        public virtual void visit(lambda_inferred_type lit) //lroman//
        {
            DefaultVisit(lit);
        }
        public virtual void visit(same_type_node stn) //SSM 22/06/13//
        {
            DefaultVisit(stn);
        }
        public virtual void visit(name_assign_expr _name_assign_expr) // SSM 27.06.13
        {
            DefaultVisit(_name_assign_expr);
        }
        public virtual void visit(name_assign_expr_list _name_assign_expr_list) // SSM 27.06.13
        {
            DefaultVisit(_name_assign_expr_list);
        }
        public virtual void visit(unnamed_type_object _unnamed_type_object) // SSM 27.06.13
        {
            DefaultVisit(_unnamed_type_object);
        }
        public virtual void visit(semantic_type_node stn) // SSM 
        {
            DefaultVisit(stn);
        }
