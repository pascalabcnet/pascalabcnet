...
namespace PascalABCNewParser
{
    public class Union
    {
	    public access_modifer_node amn;
	    public addressed_value av;
	    public array_const ac;
	    public assign a;
	    public attribute_list al;
	    public attribute at;
	    public block b;
	    public bool bo;
	    public case_node cn;
	    public case_variant cv;
	    public case_variants cvs;
	    public class_body cb;
	    public class_definition cld;
	    public const_definition cd;
	    public const_node con;
	    public consts_definitions_list cdl;
	    public class_members cm;
	    public declaration d1;
	    public declarations d;
	    public enumerator en;
	    public enumerator_list enl;
	    public exception_block eb;
	    public exception_handler eh;
	    public exception_handler_list ehl;
	    public exception_ident ei;
	    public expression ex;            // !
	    public expression_as_statement eas;
	    public expression_list el;       // !
	    public external_directive ed;
	    public file_type ft;
	    public for_cycle_type fct;
	    public for_node fn;
	    public foreach_stmt fes;
	    public format_expr fe;
	    public formal_parameters fp;
	    public get_address ga;
	    public goto_statement gs;
	    public ident id;                 // !
	    public ident_list il;
	    public if_node ifn;
	    public implementation_node ind;
	    public indexers_types it;
	    public initfinal_part ifp;
	    public inherited_message im;
	    public interface_node inn;
	    public label_definitions lds;
	    public List<object> lo;
	    public literal lit;
	    public literal_const_line lcn;
	    public lock_stmt ls;
	    public method_name mn;
	    public named_type_reference ntr;
	    public named_type_reference_list ntrl;
	    public new_expr nex;
	    public Object ob;                // !
	    public op_type_node op;
	    public op_typecast opt;
	    public operator_name_ident oni;
	    public pascal_set_constant psc;
	    public property_accessors pa;
	    public property_array_default pad;
	    public property_parameter pp;
	    public property_parameter_list ppl;
	    public procedure_attribute pat;
	    public procedure_attributes_list pal;
	    public procedure_call pc;
	    public procedure_definition pd;
	    public procedure_header ph;
	    public program_name pn;
	    public program_module pm;
	    public property_interface pint;
	    public question_colon_expression qce;
	    public raise_stmt rs;
	    public record_const rc;
	    public record_const_definition rcd;
	    public ref_type rt;
	    public repeat_node rn;
	    public set_type_definition std;
	    public simple_property sp;
	    public statement st;             // !
	    public statement_list sl;
	    public string_const sconst;
	    public syntax_tree_node node;
	    public simple_attribute_list sal;
	    public sizeof_operator soo;
	    public string_num_definition snd;
	    public SyntaxError se;
	    public template_param_list tpl;
	    public template_type_reference ttr;
	    public token_info ti;
	    public try_handler th;
	    public try_stmt ts;
	    public type_declarations tds;
	    public type_definition td;
	    public type_definition_list tdl;
	    public typecast_node tcn;
	    public typed_parameters tpars;
	    public typeof_operator too;
	    public uses_list ul;
	    public unit_module um;
	    public unit_name un;
	    public unit_or_namespace uon;
	    public using_list ugl;
	    public var_def_statement vds;
	    public var_statement vs;
	    public variable_definitions vd;
	    public where_definition_list wdl;
	    public where_definition wd;
	    public while_node wn;
	    public with_statement ws;
	    public default_operator dop;
    }
    ...
    public class PT // PT - parser tools
    {
        ...
        public string CreateErrorString(params object[] args)
        {
            string[] ww = new string[args.Length - 1];
            for (int i = 1; i < args.Length; i++)
                ww[i - 1] = (string)args[i];
            string w = string.Join(" или ", ww);
            return string.Format("Синтаксическая ошибка: встречено {0}, а ожидалось {1}", args[0], w); // Это неверно - временное исправление
        }
        ...
        public procedure_definition lambda(function_lambda_definition _function_lambda_definition)
        {
            ...
            method_name _method_name1 = new method_name(null, new ident(_function_lambda_definition.lambda_name), null);
