...
namespace PascalABCCompiler.PL0Parser
{
    public partial class GPBParser_PL0 : GPBParser
    {
        ...
        public GPBParser_PL0(Stream stream)
            : base(stream)
        {
            GrammarStream = stream;
            parsertools = new PL0_parsertools();
        }
                ...
                while (true)
                {
                    switch (LRParser.Parse())
                    {
                        ...
                        case GoldParser.ParseMessage.SyntaxError:
                            ...
                            error = new PL0Parser.Errors.UnexpectedToken(this);
                        ...
                        case GoldParser.ParseMessage.InternalError:
                            errors.Add(new CompilerInternalError("PL0Parser", new Exception("ParseMessage.InternalError")));
                            return null;

                        case GoldParser.ParseMessage.NotLoadedError:
                            errors.Add(new CompilerInternalError("PL0Parser", new Exception("ParseMessage.NotLoadedError")));
                            return null;
