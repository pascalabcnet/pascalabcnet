...
namespace PascalABCCompiler.Oberon00Parser
{
    ...
    {
        private Oberon00LanguageInformation languageInformation;
        public Oberon00LanguageParser()
            : base("Oberon00", "0.1", "(c) Stanislav Mikhalkovich, 2010", true, new string[] { ".obr" })
        {
        }

        public override ILanguageInformation LanguageInformation
        {
            get
            {
                if (languageInformation == null)
                    languageInformation = new Oberon00LanguageInformation(this);
