...
namespace PascalABCCompiler.TestParserTools
{
    public class GPBParser
    {
        ...
        {
            LRParser = null;
            LanguageGrammar = new Grammar(new BinaryReader(stream));
        }
	...
	public class parser_tools
	{
        ...
        public virtual void check_comment_text(GPBParser_PascalABC parser)
        {
        ...
        public virtual SourceContext GetTokenSourceContext(Parser parser)
        {
            int LineNum = parser.TokenLineNumber + LineCorrection;
            return new SourceContext(LineNum, parser.TokenLinePosition, LineNum, parser.TokenLinePosition + parser.TokenLength - 1, parser.TokenCharPosition, parser.TokenCharPosition + parser.TokenLength);
        }
        ...
        public virtual ident create_directive_name(GPBParser_PascalABC parser)
        {
            string text = parser.LRParser.TokenString;
            ident dn = new ident(new string(text.ToCharArray(1, text.Length - 1)));
            dn.source_context= GetTokenSourceContext(parser.LRParser);
            return dn;
        }
        ...
        public virtual char_const create_char_const(GPBParser_PascalABC parser)
        {
            string text = parser.LRParser.TokenString;
        ...
        public virtual sharp_char_const create_sharp_char_const(GPBParser_PascalABC parser)
		{
            string text = parser.LRParser.TokenString;
...
/*			catch(ArgumentNullException)
			{
				throw new InvalidNumberFormatInCompiledText(token.Text,sc.begin_position.line_num,sc.begin_position.column_num);
			}
        ...
        public virtual const_node create_double_const(GPBParser_PascalABC parser)
		{
			const_node cn=null;
            SourceContext sc = GetTokenSourceContext(parser.LRParser);//create_source_context(token);
			try
        ...
        public virtual const_node create_int_const(GPBParser_PascalABC parser)
        {
            return create_int_const(parser, System.Globalization.NumberStyles.Integer);
        }
        public virtual const_node create_hex_const(GPBParser_PascalABC parser)
        {
            return create_int_const(parser, System.Globalization.NumberStyles.HexNumber);
        }
        public virtual const_node create_int_const(GPBParser_PascalABC parser, System.Globalization.NumberStyles NumberStyles)
		{
        ...
        public virtual ident create_ident(GPBParser_PascalABC parser)
        {
            string text = parser.LRParser.TokenString;
            if (text.IndexOf('&') == 0)
                text = text.Substring(1);
        ...
        public virtual literal create_string_const(GPBParser_PascalABC parser)
		{
			literal lt;
            string text = parser.LRParser.TokenString;
