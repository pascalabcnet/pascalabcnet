...
namespace PascalABCCompiler.TestParserTools
{
    ...
    {
        public TokenReadError(PascalABCCompiler.TestParserTools.GPBParser parser)
    ...
    {
        public UnexpectedToken(PascalABCCompiler.TestParserTools.GPBParser parser,string ExpectedTokens)
