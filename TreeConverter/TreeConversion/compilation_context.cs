...
namespace PascalABCCompiler.TreeConverter
{
	...
	public class compilation_context
	{
        ...
        {
        	SymbolInfo si = _ctn.find_in_type(compiler_string_consts.noteq_name);
...
//        			cmc.parameters.AddElement(new int_const_node((vdn.type as short_string_type_node).Length,null));
		...
		private bool check_unique_or_predefined(common_function_node fn)
		{
            ...
            if (fn is common_method_node && !predef_find && syntax_tree_visitor.current_converted_method_not_in_class_defined)
            {
