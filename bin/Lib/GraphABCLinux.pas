...
type
  /// Тип пера GraphABCLinux
  GraphABCPen = class
  private
    _NETPen: System.Drawing.Pen;
    procedure SetColor(c: GraphABCLinux.Color);
    function GetColor: GraphABCLinux.Color;
  ...
  public 
    ...
    /// Цвет пера
    property Color: GraphABCLinux.Color read GetColor write SetColor;
    /// Ширина пера
  ...
  private
    ...
    procedure SetHatchBackgroundColor(c: GraphABCLinux.Color);
    function GetHatchBackgroundColor: GraphABCLinux.Color;
    procedure SetGradientSecondColor(c: GraphABCLinux.Color);
    function GetGradientSecondColor: GraphABCLinux.Color;
  public 
    /// Текущая кисть .NET
    ...
    property HatchBackgroundColor: GraphABCLinux.Color read GetHatchBackgroundColor write SetHatchBackgroundColor;
    /// Второй цвет градиентной кисти
    property GradientSecondColor: GraphABCLinux.Color read GetGradientSecondColor write SetGradientSecondColor;
  end;
  
  /// Тип шрифта GraphABCLinux
  GraphABCFont = class
  private
  ...
  public
    ...
    procedure SetTransparentColor(c: GraphABCLinux.Color);
    function GetTransparentColor: GraphABCLinux.Color;
  public 
    ...
    property TransparentColor: GraphABCLinux.Color read GetTransparentColor write SetTransparentColor;
...
/// Возвращает систему координат GraphABCLinux
...
begin
  lock f do
  begin
    {    var fnt := GraphABCLinux.Font.NETFont;
        GraphABCLinux.Font.NETFont := CurrentWriteFont;
        GraphABCLinux.Font.NETFont := fnt;}
    readbuffer := '';
  end;  
end;
...
// Graphics Primitives
// ------------ __MyPen -----------------
procedure GraphABCPen.SetColor(c: GraphABCLinux.Color);
begin
  SetPenColor(c);
end;

function GraphABCPen.GetColor: GraphABCLinux.Color;
begin
  Result := PenColor;
end;
...
procedure GraphABCBrush.SetColor(c: GraphABCLinux.Color);
begin
  SetBrushColor(c);
end;

function GraphABCBrush.GetColor: GraphABCLinux.Color;
begin
  Result := BrushColor;
end;
...
procedure GraphABCBrush.SetHatchBackgroundColor(c: GraphABCLinux.Color);
begin
  SetHatchBrushBackgroundColor(c);    
end;

function GraphABCBrush.GetHatchBackgroundColor: GraphABCLinux.Color;
begin
  Result := HatchBrushBackgroundColor;
end;

procedure GraphABCBrush.SetGradientSecondColor(c: GraphABCLinux.Color);
begin
  SetGradientBrushSecondColor(c);    
end;

function GraphABCBrush.GetGradientSecondColor: GraphABCLinux.Color;
begin
...
procedure GraphABCFont.SetColor(c: GraphABCLinux.Color);
begin
  SetFontColor(c); 
end;

function GraphABCFont.GetColor: GraphABCLinux.Color;
begin
  Result := FontColor;
end;
...
begin
  GraphABCLinuxHelper.Line(x1, y1, x2, y2, gb);
end;

procedure Picture.Line(x1, y1, x2, y2: integer; c: Color);
begin
  GraphABCLinuxHelper.Line(x1, y1, x2, y2, c, gb);
end;

procedure Picture.FillCircle(x, y, r: integer);
begin
  GraphABCLinuxHelper.FillEllipse(x - r, y - r, x + r, y + r, gb);
end;

procedure Picture.DrawCircle(x, y, r: integer);
begin
  GraphABCLinuxHelper.DrawEllipse(x - r, y - r, x + r, y + r, gb);
end;

procedure Picture.FillEllipse(x1, y1, x2, y2: integer);
begin
  GraphABCLinuxHelper.FillEllipse(x1, y1, x2, y2, gb);
end;

procedure Picture.DrawEllipse(x1, y1, x2, y2: integer);
begin
  GraphABCLinuxHelper.DrawEllipse(x1, y1, x2, y2, gb);
end;

procedure Picture.FillRectangle(x1, y1, x2, y2: integer);
begin
  GraphABCLinuxHelper.FillRectangle(x1, y1, x2, y2, gb);
end;
...
begin
  ...
  GraphABCLinux.Font.NETFont := new System.Drawing.Font('Arial', 10);
...
begin
  if GraphABCLinux.OnClose <> nil then  
    GraphABCLinux.OnClose;
...
begin
  if e.Button = MouseButtons.Left then
    ...
    mb := 2;
  if GraphABCLinux.OnMouseDown <> nil then  
    GraphABCLinux.OnMouseDown(e.x, e.y, mb); 
end;
...
begin
  if e.Button = MouseButtons.Left then
    ...
    mb := 2;
  if GraphABCLinux.OnMouseUp <> nil then  
    GraphABCLinux.OnMouseUp(e.x, e.y, mb);  
end;
...
begin
  if e.Button = MouseButtons.Left then
    ...
    mb := 2;
  if GraphABCLinux.OnMouseMove <> nil then  
    GraphABCLinux.OnMouseMove(e.x, e.y, mb);  
end;

procedure ABCControl.OnKeyDown(sender: Object; e: KeyEventArgs);
begin
  if GraphABCLinux.OnKeyDown <> nil then  
    GraphABCLinux.OnKeyDown(integer(e.KeyCode));
end;

procedure ABCControl.OnKeyUp(sender: Object; e: KeyEventArgs);
begin
  if GraphABCLinux.OnKeyUp <> nil then  
    GraphABCLinux.OnKeyUp(integer(e.KeyCode));
end;

procedure ABCControl.OnKeyPress(sender: Object; e: KeyPressEventArgs);
begin
  if GraphABCLinux.OnKeyPress <> nil then  
    GraphABCLinux.OnKeyPress(e.KeyChar);
end;
...
begin
  ResizeHelper;
  if GraphABCLinux.OnResize <> nil then  
    GraphABCLinux.OnResize;
end;
...
begin
  ...
  begin
    __initialized := true;
    GraphABCLinuxHelper.__InitModule__;
    __InitModule;
  end;
end;
