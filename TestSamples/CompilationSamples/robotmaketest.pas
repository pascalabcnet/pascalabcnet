...
procedure Rob2;
   const h=10;//высота пол€
         w=15;//ширина пол€
         step=1;//отступ помеченных клеток от кра€ пол€
   var a,i: byte;
begin
  TaskText('«акрасить клетки вокруг пр€моугольника');
  Field(w,h);
  a:=Random(h div 3)+step+1;//отступ пр€моуголька от кра€ пол€
