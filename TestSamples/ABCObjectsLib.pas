...
type
  ...
  public
    ...
    constructor Create(x,y,r,nn: integer; cl: GColor);
  ...
  public  
    procedure Init(x,y,nx,ny,sszx,sszy: integer; cl: GColor);
  ...
  public
    ...
    constructor Create(x,y,nx,ny,sszx,sszy: integer; cl: GColor);
  ...
  public
    ...
    constructor Create(x,y,nn,mm,sszx,sszy: integer; cl: GColor);
...
//  gb.TextRenderingHint := System.Drawing.Text.TextRenderingHint.AntiAlias; 
  ...
  bmp1 := nil;
//  b.Clear;
//  b.CopyRect(new System.Drawing.Rectangle(0,0,b.Width,b.Height),bmp,new System.Drawing.Rectangle(r.Left,r.Top,b.Width,b.Height));
...
begin
  ABCObjectsLib.ToFront(Self);
end;

procedure ObjectABC.ToBack;
begin
  ABCObjectsLib.ToBack(Self);
end;
...
constructor TextABC.Create(x,y,pt: integer; cl: GColor; txt: string);
begin
  Init(x,y,pt,cl,txt);
  InternalDraw;
end;
