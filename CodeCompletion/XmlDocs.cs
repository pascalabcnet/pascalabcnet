...
namespace CodeCompletion
{
	...
	/*public sealed class XmlDoc : IDisposable
	{
		...
		public static string LookupLocalizedXmlDoc(string fileName, out bool ru)
		{
			...
			ru_localizedXmlDocFile = Path.Combine(ru_localizedXmlDocFile, "ru");
		...
		public static string LookupLocalizedXmlDocForUnitWithSources(string fileName)
		{
			string xmlFileName = Path.ChangeExtension(fileName, ".xml");
			string localizedXmlDocFile = Path.GetDirectoryName(fileName);
			localizedXmlDocFile = Path.Combine(localizedXmlDocFile, CodeCompletionController.currentLanguageISO);
			localizedXmlDocFile = Path.Combine(localizedXmlDocFile, Path.GetFileName(xmlFileName));
			if (File.Exists(localizedXmlDocFile))
				return localizedXmlDocFile;
			return null;
		...
		public static string LookupLocalizedXmlDocForUnit(string fileName)
		{
			string xmlFileName = Path.ChangeExtension(fileName, ".xml");
			string localizedXmlDocFile = Path.GetDirectoryName(fileName);
			localizedXmlDocFile = Path.Combine(localizedXmlDocFile, CodeCompletionController.currentLanguageISO);
