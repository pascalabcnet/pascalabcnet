...
#pragma warning restore 649
  ...
  static SPythonGPPGParser() {
    states[0] = new State(new int[]{56,67,28,72,29,73,30,74,31,75,44,76,32,77,37,79,35,85,6,152,5,172,3,177,10,184,11,187,12,189,15,191,17,200,20,202,9,209,13,228,14,236,67,247,69,253,68,257},new int[]{-35,1,-33,3,-25,243,-23,8,-8,9,-1,66,-6,148,-7,149,-57,78,-58,84,-59,95,-22,150,-24,151,-26,170,-27,171,-28,176,-17,183,-18,186,-19,188,-20,190,-21,199,-31,201,-16,206,-43,207,-47,227,-50,245});
    states[1] = new State(new int[]{2,2});
    states[2] = new State(-1);
    states[3] = new State(new int[]{42,244,26,241,25,-148},new int[]{-53,4,-54,6});
    states[4] = new State(new int[]{25,5});
    states[5] = new State(-2);
    states[6] = new State(new int[]{56,67,28,72,29,73,30,74,31,75,44,76,32,77,37,79,35,85,6,152,5,172,3,177,10,184,11,187,12,189,15,191,17,200,20,202,9,209,13,228,14,236},new int[]{-25,7,-23,8,-8,9,-1,66,-6,148,-7,149,-57,78,-58,84,-59,95,-22,150,-24,151,-26,170,-27,171,-28,176,-17,183,-18,186,-19,188,-20,190,-21,199,-31,201,-16,206,-43,207,-47,227});
    states[7] = new State(-16);
    states[8] = new State(-17);
    states[9] = new State(new int[]{45,10,33,56,39,131,37,133,41,140,46,144,47,145,48,146,49,147},new int[]{-55,138});
    ...
    states[55] = new State(new int[]{33,56,39,131,37,133,22,136,6,-77,50,-77,52,-77,53,-77,51,-77,57,-77,58,-77,59,-77,60,-77,61,-77,62,-77,63,-77,64,-77,54,-77,55,-77,66,-77,4,-77,65,-77,42,-77,26,-77,25,-77,7,-77,40,-77,34,-77,3,-77,38,-77,36,-77,41,-77});
    states[56] = new State(new int[]{51,51,65,53,56,67,28,72,29,73,30,74,31,75,44,76,32,77,37,79,35,85,21,97,33,104,34,-144},new int[]{-15,57,-14,59,-10,102,-5,62,-8,55,-1,63,-6,68,-7,69,-57,78,-58,84,-59,95,-11,96,-12,103});
    states[57] = new State(new int[]{34,58});
    states[58] = new State(-124);
    states[59] = new State(new int[]{40,60,34,-143});
    ...
    states[61] = new State(-142);
    states[62] = new State(new int[]{6,12,50,16,52,18,53,20,51,22,57,24,58,26,59,28,60,30,61,32,62,34,63,36,64,38,54,40,55,42,66,44,4,46,65,48,40,-139,34,-139});
    ...
    states[65] = new State(new int[]{6,12,50,16,52,18,53,20,51,22,57,24,58,26,59,28,60,30,61,32,62,34,63,36,64,38,54,40,55,42,66,44,4,46,65,48,40,-140,34,-140});
    ...
    states[79] = new State(new int[]{51,51,65,53,56,67,28,72,29,73,30,74,31,75,44,76,32,77,37,79,35,85,21,97,33,104},new int[]{-32,80,-60,121,-5,123,-8,55,-1,66,-6,68,-7,69,-57,78,-58,84,-59,95,-11,96,-12,103});
    ...
    states[85] = new State(new int[]{51,51,65,53,56,67,28,72,29,73,30,74,31,75,44,76,32,77,37,79,35,85,21,97,33,104},new int[]{-32,86,-52,88,-5,119,-8,55,-1,66,-6,68,-7,69,-57,78,-58,84,-59,95,-11,96,-12,103,-56,120});
    states[86] = new State(new int[]{36,87,40,82});
    states[87] = new State(-116);
    ...
    states[99] = new State(new int[]{51,51,65,53,56,67,28,72,29,73,30,74,31,75,44,76,32,77,37,79,35,85,21,97,33,104,34,-144},new int[]{-15,100,-14,59,-10,102,-5,62,-8,55,-1,63,-6,68,-7,69,-57,78,-58,84,-59,95,-11,96,-12,103});
    states[100] = new State(new int[]{34,101});
    states[101] = new State(-83);
    states[102] = new State(-141);
    ...
    states[107] = new State(new int[]{39,108,37,111,33,-127,38,-127,40,-127,6,-127,50,-127,52,-127,53,-127,51,-127,57,-127,58,-127,59,-127,60,-127,61,-127,62,-127,63,-127,64,-127,54,-127,55,-127,66,-127,4,-127,65,-127,42,-127,26,-127,25,-127,7,-127,34,-127,3,-127,36,-127,41,-127,45,-127},new int[]{-48,110});
    states[108] = new State(new int[]{56,67},new int[]{-1,109});
    states[109] = new State(-126);
    ...
    states[115] = new State(-132);
    states[116] = new State(-125);
    states[117] = new State(-128);
    states[118] = new State(-131);
    states[119] = new State(new int[]{6,12,50,16,52,18,53,20,51,22,57,24,58,26,59,28,60,30,61,32,62,34,63,36,64,38,54,40,55,42,66,44,4,46,65,48,41,93,36,-90,40,-90});
    states[120] = new State(-47);
    states[121] = new State(new int[]{38,122});
    states[122] = new State(-113);
    states[123] = new State(new int[]{6,12,50,16,52,18,53,20,51,22,57,24,58,26,59,28,60,30,61,32,62,34,63,36,64,38,54,40,55,42,66,44,4,46,65,48,3,124,38,-90,40,-90});
    states[124] = new State(new int[]{56,67},new int[]{-1,125});
    states[125] = new State(new int[]{4,126});
    states[126] = new State(new int[]{51,51,65,53,56,67,28,72,29,73,30,74,31,75,44,76,32,77,37,79,35,85,21,97,33,104},new int[]{-5,127,-8,55,-1,66,-6,68,-7,69,-57,78,-58,84,-59,95,-11,96,-12,103});
    states[127] = new State(new int[]{6,129,50,16,52,18,53,20,51,22,57,24,58,26,59,28,60,30,61,32,62,34,63,36,64,38,54,40,55,42,66,44,4,46,65,48,38,-118},new int[]{-9,128});
    states[128] = new State(-114);
    states[129] = new State(new int[]{51,51,65,53,56,67,28,72,29,73,30,74,31,75,44,76,32,77,37,79,35,85,21,97,33,104},new int[]{-5,130,-8,55,-1,66,-6,68,-7,69,-57,78,-58,84,-59,95,-11,96,-12,103});
    states[130] = new State(new int[]{7,14,6,12,50,16,52,18,53,20,51,22,57,24,58,26,59,28,60,30,61,32,62,34,63,36,64,38,54,40,55,42,66,44,4,46,65,48,38,-119});
    states[131] = new State(new int[]{56,67},new int[]{-1,132});
    states[132] = new State(-107);
    states[133] = new State(new int[]{51,51,65,53,56,67,28,72,29,73,30,74,31,75,44,76,32,77,37,79,35,85,21,97,33,104},new int[]{-5,134,-8,55,-1,66,-6,68,-7,69,-57,78,-58,84,-59,95,-11,96,-12,103});
    states[134] = new State(new int[]{38,135,6,12,50,16,52,18,53,20,51,22,57,24,58,26,59,28,60,30,61,32,62,34,63,36,64,38,54,40,55,42,66,44,4,46,65,48});
    states[135] = new State(-112);
    states[136] = new State(new int[]{56,67},new int[]{-44,137,-45,107,-1,116,-46,117});
    states[137] = new State(-82);
    states[138] = new State(new int[]{51,51,65,53,56,67,28,72,29,73,30,74,31,75,44,76,32,77,37,79,35,85,21,97,33,104},new int[]{-5,139,-8,55,-1,66,-6,68,-7,69,-57,78,-58,84,-59,95,-11,96,-12,103});
    states[139] = new State(new int[]{6,12,50,16,52,18,53,20,51,22,57,24,58,26,59,28,60,30,61,32,62,34,63,36,64,38,54,40,55,42,66,44,4,46,65,48,42,-52,26,-52,25,-52});
    states[140] = new State(new int[]{56,67},new int[]{-44,141,-45,107,-1,116,-46,117});
    states[141] = new State(new int[]{45,142,42,-49,26,-49,25,-49});
    states[142] = new State(new int[]{51,51,65,53,56,67,28,72,29,73,30,74,31,75,44,76,32,77,37,79,35,85,21,97,33,104},new int[]{-5,143,-8,55,-1,66,-6,68,-7,69,-57,78,-58,84,-59,95,-11,96,-12,103});
    states[143] = new State(new int[]{6,12,50,16,52,18,53,20,51,22,57,24,58,26,59,28,60,30,61,32,62,34,63,36,64,38,54,40,55,42,66,44,4,46,65,48,42,-50,26,-50,25,-50});
    states[144] = new State(-53);
    states[145] = new State(-54);
    states[146] = new State(-55);
    states[147] = new State(-56);
    states[148] = new State(new int[]{45,-106,33,-106,39,-106,37,-106,41,-106,46,-106,47,-106,48,-106,49,-106,42,-104,26,-104,25,-104});
    states[149] = new State(new int[]{39,70});
    states[150] = new State(-18);
    states[151] = new State(-19);
    states[152] = new State(new int[]{51,51,65,53,56,67,28,72,29,73,30,74,31,75,44,76,32,77,37,79,35,85,21,97,33,104},new int[]{-5,153,-8,55,-1,66,-6,68,-7,69,-57,78,-58,84,-59,95,-11,96,-12,103});
    states[153] = new State(new int[]{41,154,6,12,50,16,52,18,53,20,51,22,57,24,58,26,59,28,60,30,61,32,62,34,63,36,64,38,54,40,55,42,66,44,4,46,65,48});
    states[154] = new State(new int[]{23,166},new int[]{-34,155});
    states[155] = new State(new int[]{8,157,7,163,42,-96,26,-96,25,-96},new int[]{-30,156,-29,162});
    states[156] = new State(-92);
    states[157] = new State(new int[]{51,51,65,53,56,67,28,72,29,73,30,74,31,75,44,76,32,77,37,79,35,85,21,97,33,104},new int[]{-5,158,-8,55,-1,66,-6,68,-7,69,-57,78,-58,84,-59,95,-11,96,-12,103});
    states[158] = new State(new int[]{41,159,6,12,50,16,52,18,53,20,51,22,57,24,58,26,59,28,60,30,61,32,62,34,63,36,64,38,54,40,55,42,66,44,4,46,65,48});
    states[159] = new State(new int[]{23,166},new int[]{-34,160});
    states[160] = new State(new int[]{8,157,7,163,42,-96,26,-96,25,-96},new int[]{-30,161,-29,162});
    states[161] = new State(-93);
    states[162] = new State(-94);
    states[163] = new State(new int[]{41,164});
    states[164] = new State(new int[]{23,166},new int[]{-34,165});
    states[165] = new State(-95);
    states[166] = new State(new int[]{56,67,28,72,29,73,30,74,31,75,44,76,32,77,37,79,35,85,6,152,5,172,3,177,10,184,11,187,12,189,15,191,17,200,20,202,9,209,13,228,14,236},new int[]{-33,167,-25,243,-23,8,-8,9,-1,66,-6,148,-7,149,-57,78,-58,84,-59,95,-22,150,-24,151,-26,170,-27,171,-28,176,-17,183,-18,186,-19,188,-20,190,-21,199,-31,201,-16,206,-43,207,-47,227});
    states[167] = new State(new int[]{26,241,42,242},new int[]{-54,168});
    states[168] = new State(new int[]{24,169,56,67,28,72,29,73,30,74,31,75,44,76,32,77,37,79,35,85,6,152,5,172,3,177,10,184,11,187,12,189,15,191,17,200,20,202,9,209,13,228,14,236},new int[]{-25,7,-23,8,-8,9,-1,66,-6,148,-7,149,-57,78,-58,84,-59,95,-22,150,-24,151,-26,170,-27,171,-28,176,-17,183,-18,186,-19,188,-20,190,-21,199,-31,201,-16,206,-43,207,-47,227});
    states[169] = new State(-120);
    states[170] = new State(-20);
    states[171] = new State(-21);
    states[172] = new State(new int[]{51,51,65,53,56,67,28,72,29,73,30,74,31,75,44,76,32,77,37,79,35,85,21,97,33,104},new int[]{-5,173,-8,55,-1,66,-6,68,-7,69,-57,78,-58,84,-59,95,-11,96,-12,103});
    states[173] = new State(new int[]{41,174,6,12,50,16,52,18,53,20,51,22,57,24,58,26,59,28,60,30,61,32,62,34,63,36,64,38,54,40,55,42,66,44,4,46,65,48});
    states[174] = new State(new int[]{23,166},new int[]{-34,175});
    states[175] = new State(-97);
    states[176] = new State(-22);
    states[177] = new State(new int[]{56,67},new int[]{-1,178});
    states[178] = new State(new int[]{4,179});
    states[179] = new State(new int[]{51,51,65,53,56,67,28,72,29,73,30,74,31,75,44,76,32,77,37,79,35,85,21,97,33,104},new int[]{-5,180,-8,55,-1,66,-6,68,-7,69,-57,78,-58,84,-59,95,-11,96,-12,103});
    states[180] = new State(new int[]{41,181,6,12,50,16,52,18,53,20,51,22,57,24,58,26,59,28,60,30,61,32,62,34,63,36,64,38,54,40,55,42,66,44,4,46,65,48});
    states[181] = new State(new int[]{23,166},new int[]{-34,182});
    states[182] = new State(-98);
    states[183] = new State(-23);
    states[184] = new State(new int[]{51,51,65,53,56,67,28,72,29,73,30,74,31,75,44,76,32,77,37,79,35,85,21,97,33,104,42,-101,26,-101,25,-101},new int[]{-5,185,-8,55,-1,66,-6,68,-7,69,-57,78,-58,84,-59,95,-11,96,-12,103});
    states[185] = new State(new int[]{6,12,50,16,52,18,53,20,51,22,57,24,58,26,59,28,60,30,61,32,62,34,63,36,64,38,54,40,55,42,66,44,4,46,65,48
= new State(new int[]{51,51,65,53,56,67,28,72,29,73,30,74,31,75,44,76,32,77,37,79,35,85,21,97,33,104},new int[]{-51,258,-5,259,-8,260,-1,66,-6,68,-7,69,-57,78,-58,84,-59,95,-11,96,-12,103,-23,261,-22,262});
    states[258] = new State(-7);
    states[259] = new State(new int[]{6,12,50,16,52,18,53,20,51,22,57,24,58,26,59,28,60,30,61,32,62,34,63,36,64,38,54,40,55,42,66,44,4,46,65,48,25,-12});
    states[260] = new State(new int[]{33,56,39,131,37,133,22,136,45,10,41,140,46,144,47,145,48,146,49,147,6,-77,50,-77,52,-77,53,-77,51,-77,57,-77,58,-77,59,-77,60,-77,61,-77,62,-77,63,-77,64,-77,54,-77,55,-77,66,-77,4,-77,65,-77,25,-77},new int[]{-55,138});
    states[261] = new State(-13);
    states[262] = new State(-14);
    ...
    rules[114] = new Rule(-60, new int[]{-5,3,-1,4,-5,-9});
    rules[115] = new Rule(-59, new int[]{35,-52,36});
    rules[116] = new Rule(-58, new int[]{35,-32,36});
    rules[117] = new Rule(-57, new int[]{37,-32,38});
    rules[118] = new Rule(-9, new int[]{});
    rules[119] = new Rule(-9, new int[]{6,-5});
    rules[120] = new Rule(-34, new int[]{23,-33,-54,24});
    rules[121] = new Rule(-16, new int[]{-43,-34});
    rules[122] = new Rule(-43, new int[]{9,-3,33,-39,34,41});
    rules[123] = new Rule(-43, new int[]{9,-3,33,-39,34,43,-44,41});
    rules[124] = new Rule(-6, new int[]{-8,33,-15,34});
    rules[125] = new Rule(-45, new int[]{-1});
    rules[126] = new Rule(-45, new int[]{-45,39,-1});
    rules[127] = new Rule(-44, new int[]{-45});
    rules[128] = new Rule(-44, new int[]{-46});
    rules[129] = new Rule(-46, new int[]{-45,-48});
    rules[130] = new Rule(-48, new int[]{37,-49,38});
    rules[131] = new Rule(-49, new int[]{-44});
    rules[132] = new Rule(-49, new int[]{-49,40,-44});
    rules[133] = new Rule(-36, new int[]{-1});
    rules[134] = new Rule(-37, new int[]{-36,41,-44});
    rules[135] = new Rule(-38, new int[]{-37});
    rules[136] = new Rule(-38, new int[]{-38,40,-37});
    rules[137] = new Rule(-39, new int[]{-38});
    rules[138] = new Rule(-39, new int[]{});
    rules[139] = new Rule(-10, new int[]{-5});
    rules[140] = new Rule(-10, new int[]{-1,45,-5});
    rules[141] = new Rule(-14, new int[]{-10});
    rules[142] = new Rule(-14, new int[]{-14,40,-10});
    rules[143] = new Rule(-15, new int[]{-14});
    rules[144] = new Rule(-15, new int[]{});
    rules[145] = new Rule(-54, new int[]{26});
    rules[146] = new Rule(-54, new int[]{42});
    rules[147] = new Rule(-53, new int[]{42});
    rules[148] = new Rule(-53, new int[]{});
  }
      ...
      case 113: // variable -> LBRACKET, generator_object, RBRACKET
{
        ...
        break;
      case 114: // generator_object -> expr, FOR, ident, IN, expr, optional_condition
{
        ...
        break;
      case 115: // dict_constant -> LBRACE, expr_mapping_list, RBRACE
{
        ...
        break;
      case 116: // set_constant -> LBRACE, expr_list, RBRACE
{
			CurrentSemanticValue.ex = new pascal_set_constant(ValueStack[ValueStack.Depth-2].stn as expression_list, CurrentLocationSpan);
		}
        break;
      case 117: // list_constant -> LBRACKET, expr_list, RBRACKET
{
        ...
        break;
      case 118: // optional_condition -> /* empty */
{ 
			CurrentSemanticValue.ex = null; 
		}
        break;
      case 119: // optional_condition -> IF, expr
{ 
			CurrentSemanticValue.ex = ValueStack[ValueStack.Depth-1].ex; 
		}
        break;
      case 120: // block -> INDENT, stmt_list, end_of_line, UNINDENT
{
        ...
        break;
      case 121: // proc_func_decl -> proc_func_header, block
{
        ...
        break;
      case 122: // proc_func_header -> DEF, func_name_ident, LPAR, optional_form_param_list, RPAR, 
                //                     COLON
{
                ...
                //                     ARROW, type_ref, COLON
{
        ...
        break;
      case 124: // proc_func_call -> variable, LPAR, optional_act_param_list, RPAR
{
			CurrentSemanticValue.ex = new method_call(ValueStack[ValueStack.Depth-4].ex as addressed_value, ValueStack[ValueStack.Depth-2].stn as expression_list, CurrentLocationSpan);
		}
        break;
      case 125: // simple_type_identifier -> ident
{
			CurrentSemanticValue.td = new named_type_reference(ValueStack[ValueStack.Depth-1].id, CurrentLocationSpan);
		}
        break;
      case 126: // simple_type_identifier -> simple_type_identifier, DOT, ident
{ 
			CurrentSemanticValue.td = (ValueStack[ValueStack.Depth-3].td as named_type_reference).Add(ValueStack[ValueStack.Depth-1].id, CurrentLocationSpan);
		}
        break;
      case 127: // type_ref -> simple_type_identifier
{
			CurrentSemanticValue.td = ValueStack[ValueStack.Depth-1].td as named_type_reference;
		}
        break;
      case 128: // type_ref -> template_type
{ 
			CurrentSemanticValue.td = ValueStack[ValueStack.Depth-1].td; 
		}
        break;
      case 129: // template_type -> simple_type_identifier, template_type_params
{ 
			CurrentSemanticValue.td = new template_type_reference(ValueStack[ValueStack.Depth-2].td as named_type_reference, ValueStack[ValueStack.Depth-1].stn as template_param_list, CurrentLocationSpan); 
		}
        break;
      case 130: // template_type_params -> LBRACKET, template_param_list, RBRACKET
{
			CurrentSemanticValue.stn = ValueStack[ValueStack.Depth-2].stn;
			CurrentSemanticValue.stn.source_context = CurrentLocationSpan;
		}
        break;
      case 131: // template_param_list -> type_ref
{ 
			CurrentSemanticValue.stn = new template_param_list(ValueStack[ValueStack.Depth-1].td, CurrentLocationSpan);
		}
        break;
      case 132: // template_param_list -> template_param_list, COMMA, type_ref
{ 
			CurrentSemanticValue.stn = (ValueStack[ValueStack.Depth-3].stn as template_param_list).Add(ValueStack[ValueStack.Depth-1].td, CurrentLocationSpan);
		}
        break;
      case 133: // param_name -> ident
{
			CurrentSemanticValue.stn = new ident_list(ValueStack[ValueStack.Depth-1].id, CurrentLocationSpan);
		}
        break;
      case 134: // form_param_sect -> param_name, COLON, type_ref
{
			CurrentSemanticValue.stn = new typed_parameters(ValueStack[ValueStack.Depth-3].stn as ident_list, ValueStack[ValueStack.Depth-1].td, parametr_kind.none, null, CurrentLocationSpan);
		}
        break;
      case 135: // form_param_list -> form_param_sect
{
			CurrentSemanticValue.stn = new formal_parameters(ValueStack[ValueStack.Depth-1].stn as typed_parameters, CurrentLocationSpan);
        }
        break;
      case 136: // form_param_list -> form_param_list, COMMA, form_param_sect
{
			CurrentSemanticValue.stn = (ValueStack[ValueStack.Depth-3].stn as formal_parameters).Add(ValueStack[ValueStack.Depth-1].stn as typed_parameters, CurrentLocationSpan);
        }
        break;
      case 137: // optional_form_param_list -> form_param_list
{
			CurrentSemanticValue.stn = ValueStack[ValueStack.Depth-1].stn;
		}
        break;
      case 138: // optional_form_param_list -> /* empty */
{
			CurrentSemanticValue.stn = null;
		}
        break;
      case 139: // act_param -> expr
{ 
			CurrentSemanticValue.ex = ValueStack[ValueStack.Depth-1].ex; 
		}
        break;
      case 140: // act_param -> ident, ASSIGN, expr
{ 
        ...
        break;
      case 141: // act_param_list -> act_param
{
			CurrentSemanticValue.stn = new expression_list(ValueStack[ValueStack.Depth-1].ex, CurrentLocationSpan);
		}
        break;
      case 142: // act_param_list -> act_param_list, COMMA, act_param
{
			CurrentSemanticValue.stn = (ValueStack[ValueStack.Depth-3].stn as expression_list).Add(ValueStack[ValueStack.Depth-1].ex, CurrentLocationSpan);
		}
        break;
      case 143: // optional_act_param_list -> act_param_list
{
			CurrentSemanticValue.stn = ValueStack[ValueStack.Depth-1].stn;
		}
        break;
      case 144: // optional_act_param_list -> /* empty */
{
			CurrentSemanticValue.stn = null;
		}
        break;
      case 145: // end_of_line -> END_OF_LINE
{
			CurrentSemanticValue.ob = ValueStack[ValueStack.Depth-1].ti;
		}
        break;
      case 146: // end_of_line -> SEMICOLON
{
			CurrentSemanticValue.ob = ValueStack[ValueStack.Depth-1].ti;
		}
        break;
      case 147: // optional_semicolon -> SEMICOLON
{ 
			CurrentSemanticValue.ob = ValueStack[ValueStack.Depth-1].ti; 
		}
        break;
      case 148: // optional_semicolon -> /* empty */
{ 
