...
#pragma warning restore 649
  ...
  private static string[] nonTerms = new string[] {
      ...
      "dict_constant", "$accept", };

  static SPythonGPPGParser() {
    states[0] = new State(new int[]{56,67,28,72,29,73,30,74,31,75,44,76,32,77,37,79,35,85,6,151,5,171,3,176,10,183,11,186,12,188,15,190,17,199,20,201,9,208,13,227,14,235,67,246,69,252,68,256},new int[]{-35,1,-33,3,-25,242,-23,8,-8,9,-1,66,-6,147,-7,148,-57,78,-58,84,-59,95,-22,149,-24,150,-26,169,-27,170,-28,175,-17,182,-18,185,-19,187,-20,189,-21,198,-31,200,-16,205,-43,206,-47,226,-50,244});
    states[1] = new State(new int[]{2,2});
    states[2] = new State(-1);
    states[3] = new State(new int[]{42,243,26,240,25,-147},new int[]{-53,4,-54,6});
    states[4] = new State(new int[]{25,5});
    states[5] = new State(-2);
    states[6] = new State(new int[]{56,67,28,72,29,73,30,74,31,75,44,76,32,77,37,79,35,85,6,151,5,171,3,176,10,183,11,186,12,188,15,190,17,199,20,201,9,208,13,227,14,235},new int[]{-25,7,-23,8,-8,9,-1,66,-6,147,-7,148,-57,78,-58,84,-59,95,-22,149,-24,150,-26,169,-27,170,-28,175,-17,182,-18,185,-19,187,-20,189,-21,198,-31,200,-16,205,-43,206,-47,226});
    states[7] = new State(-16);
    states[8] = new State(-17);
    states[9] = new State(new int[]{45,10,33,56,39,130,37,132,41,139,46,143,47,144,48,145,49,146},new int[]{-55,137});
    ...
    states[55] = new State(new int[]{33,56,39,130,37,132,22,135,6,-77,50,-77,52,-77,53,-77,51,-77,57,-77,58,-77,59,-77,60,-77,61,-77,62,-77,63,-77,64,-77,54,-77,55,-77,66,-77,4,-77,65,-77,42,-77,26,-77,25,-77,7,-77,40,-77,34,-77,3,-77,38,-77,36,-77,41,-77});
    states[56] = new State(new int[]{51,51,65,53,56,67,28,72,29,73,30,74,31,75,44,76,32,77,37,79,35,85,21,97,33,104,34,-143},new int[]{-15,57,-14,59,-10,102,-5,62,-8,55,-1,63,-6,68,-7,69,-57,78,-58,84,-59,95,-11,96,-12,103});
    states[57] = new State(new int[]{34,58});
    states[58] = new State(-123);
    states[59] = new State(new int[]{40,60,34,-142});
    ...
    states[62] = new State(new int[]{6,12,50,16,52,18,53,20,51,22,57,24,58,26,59,28,60,30,61,32,62,34,63,36,64,38,54,40,55,42,66,44,4,46,65,48,40,-138,34,-138});
    ...
    states[65] = new State(new int[]{6,12,50,16,52,18,53,20,51,22,57,24,58,26,59,28,60,30,61,32,62,34,63,36,64,38,54,40,55,42,66,44,4,46,65,48,40,-139,34,-139});
    ...
    states[79] = new State(new int[]{51,51,65,53,56,67,28,72,29,73,30,74,31,75,44,76,32,77,37,79,35,85,21,97,33,104},new int[]{-32,80,-5,121,-8,55,-1,66,-6,68,-7,69,-57,78,-58,84,-59,95,-11,96,-12,103});
    ...
    states[99] = new State(new int[]{51,51,65,53,56,67,28,72,29,73,30,74,31,75,44,76,32,77,37,79,35,85,21,97,33,104,34,-143},new int[]{-15,100,-14,59,-10,102,-5,62,-8,55,-1,63,-6,68,-7,69,-57,78,-58,84,-59,95,-11,96,-12,103});
    states[100] = new State(new int[]{34,101});
    states[101] = new State(-83);
    states[102] = new State(-140);
    ...
    states[107] = new State(new int[]{39,108,37,111,33,-126,38,-126,40,-126,6,-126,50,-126,52,-126,53,-126,51,-126,57,-126,58,-126,59,-126,60,-126,61,-126,62,-126,63,-126,64,-126,54,-126,55,-126,66,-126,4,-126,65,-126,42,-126,26,-126,25,-126,7,-126,34,-126,3,-126,36,-126,41,-126,45,-126},new int[]{-48,110});
    ...
    states[121] = new State(new int[]{3,122,6,12,50,16,52,18,53,20,51,22,57,24,58,26,59,28,60,30,61,32,62,34,63,36,64,38,54,40,55,42,66,44,4,46,65,48,38,-90,40,-90});
    ...
    states[125] = new State(new int[]{6,128,50,16,52,18,53,20,51,22,57,24,58,26,59,28,60,30,61,32,62,34,63,36,64,38,54,40,55,42,66,44,4,46,65,48,38,-117},new int[]{-9,126});
    states[126] = new State(new int[]{38,127});
    states[127] = new State(-113);
    states[128] = new State(new int[]{51,51,65,53,56,67,28,72,29,73,30,74,31,75,44,76,32,77,37,79,35,85,21,97,33,104},new int[]{-5,129,-8,55,-1,66,-6,68,-7,69,-57,78,-58,84,-59,95,-11,96,-12,103});
    states[129] = new State(new int[]{7,14,6,12,50,16,52,18,53,20,51,22,57,24,58,26,59,28,60,30,61,32,62,34,63,36,64,38,54,40,55,42,66,44,4,46,65,48,38,-118});
    states[130] = new State(new int[]{56,67},new int[]{-1,131});
    states[131] = new State(-107);
    states[132] = new State(new int[]{51,51,65,53,56,67,28,72,29,73,30,74,31,75,44,76,32,77,37,79,35,85,21,97,33,104},new int[]{-5,133,-8,55,-1,66,-6,68,-7,69,-57,78,-58,84,-59,95,-11,96,-12,103});
    states[133] = new State(new int[]{38,134,6,12,50,16,52,18,53,20,51,22,57,24,58,26,59,28,60,30,61,32,62,34,63,36,64,38,54,40,55,42,66,44,4,46,65,48});
    states[134] = new State(-112);
    states[135] = new State(new int[]{56,67},new int[]{-44,136,-45,107,-1,116,-46,117});
    states[136] = new State(-82);
    states[137] = new State(new int[]{51,51,65,53,56,67,28,72,29,73,30,74,31,75,44,76,32,77,37,79,35,85,21,97,33,104},new int[]{-5,138,-8,55,-1,66,-6,68,-7,69,-57,78,-58,84,-59,95,-11,96,-12,103});
    states[138] = new State(new int[]{6,12,50,16,52,18,53,20,51,22,57,24,58,26,59,28,60,30,61,32,62,34,63,36,64,38,54,40,55,42,66,44,4,46,65,48,42,-52,26,-52,25,-52});
    states[139] = new State(new int[]{56,67},new int[]{-44,140,-45,107,-1,116,-46,117});
    states[140] = new State(new int[]{45,141,42,-49,26,-49,25,-49});
    states[141] = new State(new int[]{51,51,65,53,56,67,28,72,29,73,30,74,31,75,44,76,32,77,37,79,35,85,21,97,33,104},new int[]{-5,142,-8,55,-1,66,-6,68,-7,69,-57,78,-58,84,-59,95,-11,96,-12,103});
    states[142] = new State(new int[]{6,12,50,16,52,18,53,20,51,22,57,24,58,26,59,28,60,30,61,32,62,34,63,36,64,38,54,40,55,42,66,44,4,46,65,48,42,-50,26,-50,25,-50});
    states[143] = new State(-53);
    states[144] = new State(-54);
    states[145] = new State(-55);
    states[146] = new State(-56);
    states[147] = new State(new int[]{45,-106,33,-106,39,-106,37,-106,41,-106,46,-106,47,-106,48,-106,49,-106,42,-104,26,-104,25,-104});
    states[148] = new State(new int[]{39,70});
    states[149] = new State(-18);
    states[150] = new State(-19);
    states[151] = new State(new int[]{51,51,65,53,56,67,28,72,29,73,30,74,31,75,44,76,32,77,37,79,35,85,21,97,33,104},new int[]{-5,152,-8,55,-1,66,-6,68,-7,69,-57,78,-58,84,-59,95,-11,96,-12,103});
    states[152] = new State(new int[]{41,153,6,12,50,16,52,18,53,20,51,22,57,24,58,26,59,28,60,30,61,32,62,34,63,36,64,38,54,40,55,42,66,44,4,46,65,48});
    states[153] = new State(new int[]{23,165},new int[]{-34,154});
    states[154] = new State(new int[]{8,156,7,162,42,-96,26,-96,25,-96},new int[]{-30,155,-29,161});
    states[155] = new State(-92);
    states[156] = new State(new int[]{51,51,65,53,56,67,28,72,29,73,30,74,31,75,44,76,32,77,37,79,35,85,21,97,33,104},new int[]{-5,157,-8,55,-1,66,-6,68,-7,69,-57,78,-58,84,-59,95,-11,96,-12,103});
    ...
    states[158] = new State(new int[]{23,165},new int[]{-34,159});
    states[159] = new State(new int[]{8,156,7,162,42,-96,26,-96,25,-96},new int[]{-30,160,-29,161});
    states[160] = new State(-93);
    states[161] = new State(-94);
    states[162] = new State(new int[]{41,163});
    states[163] = new State(new int[]{23,165},new int[]{-34,164});
    states[164] = new State(-95);
    states[165] = new State(new int[]{56,67,28,72,29,73,30,74,31,75,44,76,32,77,37,79,35,85,6,151,5,171,3,176,10,183,11,186,12,188,15,190,17,199,20,201,9,208,13,227,14,235},new int[]{-33,166,-25,242,-23,8,-8,9,-1,66,-6,147,-7,148,-57,78,-58,84,-59,95,-22,149,-24,150,-26,169,-27,170,-28,175,-17,182,-18,185,-19,187,-20,189,-21,198,-31,200,-16,205,-43,206,-47,226});
    states[166] = new State(new int[]{26,240,42,241},new int[]{-54,167});
    states[167] = new State(new int[]{24,168,56,67,28,72,29,73,30,74,31,75,44,76,32,77,37,79,35,85,6,151,5,171,3,176,10,183,11,186,12,188,15,190,17,199,20,201,9,208,13,227,14,235},new int[]{-25,7,-23,8,-8,9,-1,66,-6,147,-7,148,-57,78,-58,84,-59,95,-22,149,-24,150,-26,169,-27,170,-28,175,-17,182,-18,185,-19,187,-20,189,-21,198,-31,200,-16,205,-43,206,-47,226});
    states[168] = new State(-119);
    states[169] = new State(-20);
    states[170] = new State(-21);
    states[171] = new State(new int[]{51,51,65,53,56,67,28,72,29,73,30,74,31,75,44,76,32,77,37,79,35,85,21,97,33,104},new int[]{-5,172,-8,55,-1,66,-6,68,-7,69,-57,78,-58,84,-59,95,-11,96,-12,103});
    states[172] = new State(new int[]{41,173,6,12,50,16,52,18,53,20,51,22,57,24,58,26,59,28,60,30,61,32,62,34,63,36,64,38,54,40,55,42,66,44,4,46,65,48});
    states[173] = new State(new int[]{23,165},new int[]{-34,174});
    states[174] = new State(-97);
    states[175] = new State(-22);
    states[176] = new State(new int[]{56,67},new int[]{-1,177});
    states[177] = new State(new int[]{4,178});
    states[178] = new State(new int[]{51,51,65,53,56,67,28,72,29,73,30,74,31,75,44,76,32,77,37,79,35,85,21,97,33,104},new int[]{-5,179,-8,55,-1,66,-6,68,-7,69,-57,78,-58,84,-59,95,-11,96,-12,103});
    states[179] = new State(new int[]{41,180,6,12,50,16,52,18,53,20,51,22,57,24,58,26,59,28,60,30,61,32,62,34,63,36,64,38,54,40,55,42,66,44,4,46,65,48});
    states[180] = new State(new int[]{23,165},new int[]{-34,181});
    states[181] = new State(-98);
    states[182] = new State(-23);
    states[183] = new State(new int[]{51,51,65,53,56,67,28,72,29,73,30,74,31,75,44,76,32,77,37,79,35,85,21,97,33,104,42,-101,26,-101,25,-101},new int[]{-5,184,-8,55,-1,66,-6,68,-7,69,-57,78,-58,84,-59,95,-11,96,-12,103});
    states[184] = new State(new int[]{6,12,50,16,52,18,53,20,51,22,57,24,58,26,59,28,60,30,61,32,62,34,63,36,64,38,54,40,55,42,66,44,4,46,65,48,42,-100,26,-100,25,-100});
    states[185] = new State(-24);
    states[186] = new State(-102);
    states[187] = new State(-25);
    states[188] = new State(-103);
    states[189] = new State(-26);
    states[190] = new State(new int[]{56,67},new int[]{-40,191,-2,197,-1,196});
    states[191] = new State(new int[]{40,192,42,-36,26,-36,25,-36});
    states[192] = new State(new int[]{56,67},new int[]{-2,193,-1,196});
    states[193] = new State(new int[]{39,194,40,-41,42,-41,26,-41,25,-41});
    states[194] = new State(new int[]{56,67},new int[]{-1,195});
    states[195] = new State(-39);
    states[196] = new State(-38);
    states[197] = new State(new int[]{39,194,40,-40,42,-40,26,-40,25,-40});
    states[198] = new State(-27);
    states[199] = new State(-34);
    states[200] = new State(-28);
    states[201] = new State(new int[]{33,202});
    states[202] = new State(new int[]{51,51,65,53,56,67,28,72,29,73,30,74,31,75,44,76,32,77,37,79,35,85,21,97,33,104,34,-143},new int[]{-15,203,-14,59,-10,102,-5,62,-8,55,-1,63,-6,68,-7,69,-57,78,-58,84,-59,95,-11,96,-12,103});
    states[203] = new State(new int[]{34,204});
    states[204] = new State(-35);
    states[205] = new State(-29);
    states[206] = new State(new int[]{23,165},new int[]{-34,207});
    states[207] = new State(-120);
    states[208] = new State(new int[]{56,67},new int[]{-3,209,-1,225});
    states[209] = new State(new int[]{33,210});
    states[210] = new State(new int[]{56,67,34,-137},new int[]{-39,211,-38,217,-37,224,-36,220,-1,223});
    states[211] = new State(new int[]{34,212});
    states[212] = new State(new int[]{41,213,43,214});
    states[213] = new State(-121);
    states[214] = new State(new int[]{56,67},new int[]{-44,215,-45,107,-1,116,-46,117});
    states[215] = new State(new int[]{41,216});
    states[216] = new State(-122);
    states[217] = new State(new int[]{40,218,34,-136});
    states[218] = new State(new int[]{56,67},new int[]{-37,219,-36,220,-1,223});
    states[219] = new State(-135);
    states[220] = new State(new int[]{41,221});
    states[221] = new State(new int[]{56,67},new int[]{-44,222,-45,107,-1,116,-46,117});
    states[222] = new State(-133);
    states[223] = new State(-132);
    states[224] = new State(-134);
    states[225] = new State(-99);
    states[226] = new State(-30);
    states[227] = new State(new int[]{56,67},new int[]{-42,228,-41,234,-1,231});
    states[228] = new State(new int[]{40,229,42,-31,26,-31,25,-31});
    states[229] = new State(new int[]{56,67},new int[]{-41,230,-1,231});
    states[230] = new State(-45);
    states[231] = new State(new int[]{16,232,40,-43,42,-43,26,-43,25,-43});
    states[232] = new State(new int[]{56,67},new int[]{-1,233});
    states[233] = new State(-42);
    states[234] = new State(-44);
    states[235] = new State(new int[]{56,67},new int[]{-1,236});
    states[236] = new State(new int[]{13,237});
    states[237] = new State(new int[]{52,239,56,67},new int[]{-42,238,-41,234,-1,231});
    states[238] = new State(new int[]{40,229,42,-32,26,-32,25,-32});
    states[239] = new State(-33);
    states[240] = new State(-144);
    states[241] = new State(-145);
    states[242] = new State(-15);
    states[243] = new State(new int[]{25,-146,56,-145,28,-145,29,-145,30,-145,31,-145,44,-145,32,-145,37,-145,35,-145,6,-145,5,-145,3,-145,10,-145,11,-145,12,-145,15,-145,17,-145,20,-145,9,-145,13,-145,14,-145});
    states[244] = new State(new int[]{25,245});
    states[245] = new State(-3);
    states[246] = new State(new int[]{27,248,51,51,65,53,56,67,28,72,29,73,30,74,31,75,44,76,32,77,37,79,35,85,21,97,33,104},new int[]{-5,247,-8,55,-1,66,-6,68,-7,69,-57,78,-58,84,-59,95,-11,96,-12,103});
    states[247] = new State(new int[]{6,12,50,16,52,18,53,20,51,22,57,24,58,26,59,28,60,30,61,32,62,34,63,36,64,38,54,40,55,42,66,44,4,46,65,48,25,-4});
    states[248] = new State(new int[]{56,67},new int[]{-4,249,-1,250});
    states[249] = new State(-5);
    states[250] = new State(new int[]{37,111,25,-8},new int[]{-48,251});
    states[251] = new State(-9);
    states[252] = new State(new int[]{56,67},new int[]{-13,253,-2,254,-1,196});
    states[253] = new State(-6);
    states[254] = new State(new int[]{39,194,37,111,25,-10},new int[]{-48,255});
    states[255] = new State(-11);
    states[256] = new State(new int[]{51,51,65,53,56,67,28,72,29,73,30,74,31,75,44,76,32,77,37,79,35,85,21,97,33,104},new int[]{-51,257,-5,258,-8,259,-1,66,-6,68,-7,69,-57,78,-58,84,-59,95,-11,96,-12,103,-23,260,-22,261});
    states[257] = new State(-7);
    states[258] = new State(new int[]{6,12,50,16,52,18,53,20,51,22,57,24,58,26,59,28,60,30,61,32,62,34,63,36,64,38,54,40,55,42,66,44,4,46,65,48,25,-12});
    states[259] = new State(new int[]{33,56,39,130,37,132,22,135,45,10,41,139,46,143,47,144,48,145,49,146,6,-77,50,-77,52,-77,53,-77,51,-77,57,-77,58,-77,59,-77,60,-77,61,-77,62,-77,63,-77,64,-77,54,-77,55,-77,66,-77,4,-77,65,-77,25,-77},new int[]{-55,137});
    states[260] = new State(-13);
    states[261] = new State(-14);

    rules[1] = new Rule(-60, new int[]{-35,2});
    ...
    rules[113] = new Rule(-8, new int[]{37,-5,3,-1,4,-5,-9,38});
    rules[114] = new Rule(-59, new int[]{35,-52,36});
    rules[115] = new Rule(-58, new int[]{35,-32,36});
    rules[116] = new Rule(-57, new int[]{37,-32,38});
    rules[117] = new Rule(-9, new int[]{});
    rules[118] = new Rule(-9, new int[]{6,-5});
    rules[119] = new Rule(-34, new int[]{23,-33,-54,24});
    rules[120] = new Rule(-16, new int[]{-43,-34});
    rules[121] = new Rule(-43, new int[]{9,-3,33,-39,34,41});
    rules[122] = new Rule(-43, new int[]{9,-3,33,-39,34,43,-44,41});
    rules[123] = new Rule(-6, new int[]{-8,33,-15,34});
    rules[124] = new Rule(-45, new int[]{-1});
    rules[125] = new Rule(-45, new int[]{-45,39,-1});
    rules[126] = new Rule(-44, new int[]{-45});
    rules[127] = new Rule(-44, new int[]{-46});
    rules[128] = new Rule(-46, new int[]{-45,-48});
    rules[129] = new Rule(-48, new int[]{37,-49,38});
    rules[130] = new Rule(-49, new int[]{-44});
    rules[131] = new Rule(-49, new int[]{-49,40,-44});
    rules[132] = new Rule(-36, new int[]{-1});
    rules[133] = new Rule(-37, new int[]{-36,41,-44});
    rules[134] = new Rule(-38, new int[]{-37});
    rules[135] = new Rule(-38, new int[]{-38,40,-37});
    rules[136] = new Rule(-39, new int[]{-38});
    rules[137] = new Rule(-39, new int[]{});
    rules[138] = new Rule(-10, new int[]{-5});
    rules[139] = new Rule(-10, new int[]{-1,45,-5});
    rules[140] = new Rule(-14, new int[]{-10});
    rules[141] = new Rule(-14, new int[]{-14,40,-10});
    rules[142] = new Rule(-15, new int[]{-14});
    rules[143] = new Rule(-15, new int[]{});
    rules[144] = new Rule(-54, new int[]{26});
    rules[145] = new Rule(-54, new int[]{42});
    rules[146] = new Rule(-53, new int[]{42});
    rules[147] = new Rule(-53, new int[]{});
  }
      ...
      case 114: // dict_constant -> LBRACE, expr_mapping_list, RBRACE
{
        ...
        break;
      case 115: // set_constant -> LBRACE, expr_list, RBRACE
{
			CurrentSemanticValue.ex = new pascal_set_constant(ValueStack[ValueStack.Depth-2].stn as expression_list, CurrentLocationSpan);
		}
        break;
      case 116: // list_constant -> LBRACKET, expr_list, RBRACKET
{
        ...
        break;
      case 117: // optional_condition -> /* empty */
{ 
			CurrentSemanticValue.ex = null; 
		}
        break;
      case 118: // optional_condition -> IF, expr
{ 
			CurrentSemanticValue.ex = ValueStack[ValueStack.Depth-1].ex; 
		}
        break;
      case 119: // block -> INDENT, stmt_list, end_of_line, UNINDENT
{
        ...
        break;
      case 120: // proc_func_decl -> proc_func_header, block
{
        ...
        break;
      case 121: // proc_func_header -> DEF, func_name_ident, LPAR, optional_form_param_list, RPAR, 
                //                     COLON
{
                ...
                //                     ARROW, type_ref, COLON
{
        ...
        break;
      case 123: // proc_func_call -> variable, LPAR, optional_act_param_list, RPAR
{
			CurrentSemanticValue.ex = new method_call(ValueStack[ValueStack.Depth-4].ex as addressed_value, ValueStack[ValueStack.Depth-2].stn as expression_list, CurrentLocationSpan);
		}
        break;
      case 124: // simple_type_identifier -> ident
{
			CurrentSemanticValue.td = new named_type_reference(ValueStack[ValueStack.Depth-1].id, CurrentLocationSpan);
		}
        break;
      case 125: // simple_type_identifier -> simple_type_identifier, DOT, ident
{ 
			CurrentSemanticValue.td = (ValueStack[ValueStack.Depth-3].td as named_type_reference).Add(ValueStack[ValueStack.Depth-1].id, CurrentLocationSpan);
		}
        break;
      case 126: // type_ref -> simple_type_identifier
{
			CurrentSemanticValue.td = ValueStack[ValueStack.Depth-1].td as named_type_reference;
		}
        break;
      case 127: // type_ref -> template_type
{ 
			CurrentSemanticValue.td = ValueStack[ValueStack.Depth-1].td; 
		}
        break;
      case 128: // template_type -> simple_type_identifier, template_type_params
{ 
			CurrentSemanticValue.td = new template_type_reference(ValueStack[ValueStack.Depth-2].td as named_type_reference, ValueStack[ValueStack.Depth-1].stn as template_param_list, CurrentLocationSpan); 
		}
        break;
      case 129: // template_type_params -> LBRACKET, template_param_list, RBRACKET
{
			CurrentSemanticValue.stn = ValueStack[ValueStack.Depth-2].stn;
			CurrentSemanticValue.stn.source_context = CurrentLocationSpan;
		}
        break;
      case 130: // template_param_list -> type_ref
{ 
			CurrentSemanticValue.stn = new template_param_list(ValueStack[ValueStack.Depth-1].td, CurrentLocationSpan);
		}
        break;
      case 131: // template_param_list -> template_param_list, COMMA, type_ref
{ 
			CurrentSemanticValue.stn = (ValueStack[ValueStack.Depth-3].stn as template_param_list).Add(ValueStack[ValueStack.Depth-1].td, CurrentLocationSpan);
		}
        break;
      case 132: // param_name -> ident
{
			CurrentSemanticValue.stn = new ident_list(ValueStack[ValueStack.Depth-1].id, CurrentLocationSpan);
		}
        break;
      case 133: // form_param_sect -> param_name, COLON, type_ref
{
			CurrentSemanticValue.stn = new typed_parameters(ValueStack[ValueStack.Depth-3].stn as ident_list, ValueStack[ValueStack.Depth-1].td, parametr_kind.none, null, CurrentLocationSpan);
		}
        break;
      case 134: // form_param_list -> form_param_sect
{
			CurrentSemanticValue.stn = new formal_parameters(ValueStack[ValueStack.Depth-1].stn as typed_parameters, CurrentLocationSpan);
        }
        break;
      case 135: // form_param_list -> form_param_list, COMMA, form_param_sect
{
			CurrentSemanticValue.stn = (ValueStack[ValueStack.Depth-3].stn as formal_parameters).Add(ValueStack[ValueStack.Depth-1].stn as typed_parameters, CurrentLocationSpan);
        }
        break;
      case 136: // optional_form_param_list -> form_param_list
{
			CurrentSemanticValue.stn = ValueStack[ValueStack.Depth-1].stn;
		}
        break;
      case 137: // optional_form_param_list -> /* empty */
{
			CurrentSemanticValue.stn = null;
		}
        break;
      case 138: // act_param -> expr
{ 
			CurrentSemanticValue.ex = ValueStack[ValueStack.Depth-1].ex; 
		}
        break;
      case 139: // act_param -> ident, ASSIGN, expr
{ 
        ...
        break;
      case 140: // act_param_list -> act_param
{
			CurrentSemanticValue.stn = new expression_list(ValueStack[ValueStack.Depth-1].ex, CurrentLocationSpan);
		}
        break;
      case 141: // act_param_list -> act_param_list, COMMA, act_param
{
			CurrentSemanticValue.stn = (ValueStack[ValueStack.Depth-3].stn as expression_list).Add(ValueStack[ValueStack.Depth-1].ex, CurrentLocationSpan);
		}
        break;
      case 142: // optional_act_param_list -> act_param_list
{
			CurrentSemanticValue.stn = ValueStack[ValueStack.Depth-1].stn;
		}
        break;
      case 143: // optional_act_param_list -> /* empty */
{
			CurrentSemanticValue.stn = null;
		}
        break;
      case 144: // end_of_line -> END_OF_LINE
{
			CurrentSemanticValue.ob = ValueStack[ValueStack.Depth-1].ti;
		}
        break;
      case 145: // end_of_line -> SEMICOLON
{
			CurrentSemanticValue.ob = ValueStack[ValueStack.Depth-1].ti;
		}
        break;
      case 146: // optional_semicolon -> SEMICOLON
{ 
			CurrentSemanticValue.ob = ValueStack[ValueStack.Depth-1].ti; 
		}
        break;
      case 147: // optional_semicolon -> /* empty */
{ 
