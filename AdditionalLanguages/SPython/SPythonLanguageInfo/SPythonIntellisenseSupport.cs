...
{
    internal class SPythonIntellisenseSupport : BaseLanguageIntellisenseSupport
    {
        ...
        {
            var p = LanguageInformation.SpecialModulesAliases.FirstOrDefault(kv => kv.Value == scope.Name);
