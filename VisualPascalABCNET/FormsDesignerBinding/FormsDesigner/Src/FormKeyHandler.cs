...
namespace ICSharpCode.FormsDesigner
{
	public sealed class FormKeyHandler : IMessageFilter
	{
		...
		public FormKeyHandler()
		{
            ...
            //roman//
            keyTable[Keys.Control | Keys.X] = new CommandWrapper(MenuCommands.Cut);
            keyTable[Keys.Control | Keys.C] = new CommandWrapper(MenuCommands.Copy);
            keyTable[Keys.Control | Keys.V] = new CommandWrapper(MenuCommands.Paste);
            //roman//
