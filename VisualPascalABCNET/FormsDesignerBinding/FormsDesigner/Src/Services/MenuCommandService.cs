...
namespace ICSharpCode.FormsDesigner.Services
{
	...
	public class MenuCommandService : System.ComponentModel.Design.IMenuCommandService
	{
		...
		public void ShowContextMenu(System.ComponentModel.Design.CommandID menuID, int x, int y)
		{
            ...
            /*—ледующее делаетс€ по следующей причине:
                * почему то при menu.Items.AddRange(menuItems1); удал€ютс€ элементы из VisualPascalABC.Form1.Form1_object.cm_Designer,
                * аналогично дл€ menu.Items.AddRange(menuItems2);
                */
