...
namespace ICSharpCode.FormsDesigner.Services
{
	public class SharpDevelopDesignerOptions : DesignerOptions
	{
		...
		public SharpDevelopDesignerOptions()
		{
			...
			this.showGrid   = /*PropertyService.Get("FormsDesigner.DesignerOptions.ShowGrid", true)*/false; //roman//
			this.snapToGrid = /*PropertyService.Get("FormsDesigner.DesignerOptions.SnapToGrid", true)*/ false;
	...
	{		
		...
		void ApplySharpDevelopSettings()
		{
			...
			if (options.UseSnapLines) {*/
                ...
                this.Options.Properties.Find("UseSnapLines", true).SetValue(this, true);
                this.Options.Properties.Find("UseSmartTags", true).SetValue(this, true);
			/*} else {
